...
public:
	...
	TFloatValue getMinValue(const SASNumericExpression* term, int stateIndex, std::vector<SASControlVar>* cvs);
	TFloatValue getMaxValue(const SASNumericExpression* term, int stateIndex, std::vector<SASControlVar>* cvs);
};
