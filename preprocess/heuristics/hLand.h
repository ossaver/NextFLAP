...
public:
	...
	inline unsigned int numPrev() { return (unsigned int)prev.size(); }
	inline unsigned int numNext() { return (unsigned int)next.size(); }
...
public:
	...
	inline unsigned int getNumNodes() { return (unsigned int)nodes.size(); }
