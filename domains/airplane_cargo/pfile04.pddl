...
(:init
	...
	(= (plane_tank_level plane0) 335)

	(= (tanker_capacity tanker0) 25000)

	(= (tanker_level tanker0) 56)

	(= (flying_distance airport0 airport1) 180)
	(= (flying_distance airport0 airport2) 166)
	(= (flying_distance airport1 airport0) 129)
	(= (flying_distance airport1 airport2) 101)
	(= (flying_distance airport2 airport0) 145)
	(= (flying_distance airport2 airport1) 232)
)
