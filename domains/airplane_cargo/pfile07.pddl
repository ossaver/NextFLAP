...
(:objects
	...
	cargo0 cargo1 cargo2 cargo3 cargo4 cargo5  - cargo
)
...
(:init
	...
	(= (plane_tank_level plane0) 78)
	(= (plane_tank_level plane1) 60)

	(= (tanker_capacity tanker0) 25000)

	(= (tanker_level tanker0) 58)

	(= (flying_distance airport0 airport1) 110)
	(= (flying_distance airport0 airport2) 234)
	(= (flying_distance airport1 airport0) 202)
	(= (flying_distance airport1 airport2) 172)
	(= (flying_distance airport2 airport0) 131)
	(= (flying_distance airport2 airport1) 140)
)
